    ...
    <main className="flex min-h-screen items-center justify-center bg-tactical-bg px-4 py-8">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <span className="mt-5 inline-block rounded-full border border-tactical-red/40 bg-tactical-red/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-tactical-red">
            Valorant Coach
          </span>
